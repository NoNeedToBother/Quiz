...
class GetFriendsLeaderboardUseCaseImplTests {
    ...
    fun getFriendsLeaderboardUseCaseImpl_success() = runTest {
        ...
        val resultRepository = mock<ResultRepository> {
            onBlocking { getFriendsResults(GameMode.BLITZ, null, null, 2, null) } doReturn mockedResults
        }

        val impl = GetFriendsLeaderboardUseCaseImpl(dispatcher, resultRepository)
