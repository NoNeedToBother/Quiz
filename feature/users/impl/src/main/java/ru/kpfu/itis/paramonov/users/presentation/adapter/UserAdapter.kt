package ru.kpfu.itis.paramonov.users.presentation.adapter
...
import ru.kpfu.itis.paramonov.users.presentation.viewholder.UserViewHolder
...
class UserAdapter(
    ...
    override fun onBindViewHolder(holder: UserViewHolder, position: Int) {
        ...
        holder.binding.root.startAnimation(AnimationUtils.loadAnimation(
            holder.binding.root.context, ru.kpfu.itis.paramonov.ui.R.anim.recyler_view_item_enter_anim
        ))
    }
